...
target_dataset = dataset_base.copy({
  'name': 'Cyclist Dataset - COCO Dataset',
  'train_info': '/content/drive/MyDrive/Datasets/Train/coco500 new.json',
  'train_images': '/content/drive/MyDrive/Datasets/Train/Images',
  'valid_info': '/content/drive/MyDrive//Datasets/Val/example.json',
  'valid_images': '/content/drive/MyDrive/Datasets/Val/Images',
  'class_names': ('Bicycle', 'Cyclist'),
  'label_map': { 1: 1, 2: 2 }
})
...
yolact_resnet50_target_dataset_config = yolact_resnet50_config.copy({
    'name': target_dataset, # Will default to yolact_resnet50_pascal
